;; z80asm.exe Basic.asm -cim
;; python3 conv.py Basic.cim > Basic.c
; zmac Basic.asm  --od Basic --oo cim,lst -c -s -g
; python3 conv.py Basic/Basic.cim > Basic.c 
;
;*************************************************************
;
...
SerialPort:     EQU     01H            ; This the serial output port
SERIAL_STATUS:  EQU     02H
